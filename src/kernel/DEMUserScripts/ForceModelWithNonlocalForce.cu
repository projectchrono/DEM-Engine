...
// Normal force. But you know, if you are simulating a solver system like the demo that uses this force model, then the
// normal force does not matter unless 2 planets collide...
if (overlapDepth > 0.) {
