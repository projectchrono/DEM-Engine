...
// Provide a minimal fallback.
    ...
    enum hipMemoryType { hipMemoryTypeUnregistered = 0, hipMemoryTypeHost = 1,
                         hipMemoryTypeDevice = 2, hipMemoryTypeManaged = 3 };
#endif
...
// For most physics simulations, the difference is negligible.
    ...
    __device__ inline float __frcp_ru(float x) { return 1.0f / x; }
    __device__ inline double __drcp_ru(double x) { return 1.0 / x; }
    __device__ inline float __fmul_ru(float x, float y) { return x * y; }
    __device__ inline double __dmul_ru(double x, double y) { return x * y; }
    __device__ inline float __fadd_ru(float x, float y) { return x + y; }
    __device__ inline double __dadd_ru(double x, double y) { return x + y; }
#endif
