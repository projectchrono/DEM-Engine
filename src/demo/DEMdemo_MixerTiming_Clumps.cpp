...
int main() {
    float granular_rad = 0.000979453 * std::pow(0.55, 1. / 3.);
...

    {
        ...
        // Sampler to use
        HCPSampler sampler(2.7f * granular_rad);
        ...
        std::cout << "Total num of spheres: " << num_particles * template_granular->nComp << std::endl;
        ...
        out_dir += "/DemoOutput_Mixer_3clump";
