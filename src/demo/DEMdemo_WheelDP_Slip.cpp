...
int main() {
    ...
    out_dir += "/DEMdemo_WheelDP_Slip_mu0.9";
    ...
    for (float DP : DPs) {
        ...
        // E, nu, CoR, mu, Crr...
        // 0.8 is the default
        auto mat_type_wheel = DEMSim.LoadMaterial({{"E", 1e9}, {"nu", 0.3}, {"CoR", 0.3}, {"mu", 0.9}, {"Crr", 0.00}});
        auto mat_type_terrain =
            DEMSim.LoadMaterial({{"E", 1e9}, {"nu", 0.3}, {"CoR", 0.3}, {"mu", 0.9}, {"Crr", 0.00}});
