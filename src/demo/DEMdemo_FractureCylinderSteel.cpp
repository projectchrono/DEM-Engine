...
int main() {
    ...
    auto mat_type_particle = DEMSim.LoadMaterial({{"E", 10e9}, {"nu", 0.20}, {"CoR", 0.5}, {"mu", 0.5}, {"Crr", 0.05}});
    ...
    auto my_force_model = DEMSim.ReadContactForceModel("ForceModelSteel.cu");
    ...
    DEMSim.SetFamilyPrescribedLinVel(21, "0", "0", to_string_with_precision(-0.020));
    ...
    std::cout << "Total num of particles: " << particles_pile->GetNumClumps() << std::endl;
