...
int main() {
    ...
    out_dir += "/DEMdemo_WheelDP_Force_mu0.9_HighDensity";
    ...
    for (float TR : TRs) {
        ...
        auto my_force_model = DEMSim.ReadContactForceModel("VarMuForceModel.cu");
        ...
        // E, nu, CoR, mu, Crr...
        auto mat_type_wheel = DEMSim.LoadMaterial({{"E", 1e9}, {"nu", 0.3}, {"CoR", 0.5}});
        ...
        // Now we load clump locations from a checkpointed file
        {
            ...
            */
            ...
            auto terrain = DEMSim.AddClumps(base_batch);
            terrain->AddOwnerWildcard("mu_custom", 0.0);
        }
